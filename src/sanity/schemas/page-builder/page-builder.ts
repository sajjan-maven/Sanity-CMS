    ...
    insertMenu: {
      groups: [
        ...
        },
        {
          name: 'content',
          title: 'Content',
          of: [ 'freeformBlock', 'mediaBlock', 'portableTextBlock', 'simpleCardBlock', 'comparisonTableBlock', 'stepProcessBlock', 'clickthroughTopicBlock', 'stepRightImageBlock', 'iconListBlock', 'iconListTwoColumnBlock', 'iconHighlightBlock' ]
        },
        {
          name: 'marketing',
          title: 'Marketing',
