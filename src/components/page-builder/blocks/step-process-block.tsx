...
export default function StepProcessBlock(props: StepProcessBlockProps) {
  ...
  return (
    <section
      ...
      style={{ backgroundColor: backgroundColor?.value || '#F8F5F3' }}
    >
      ...
      <div className="w-full max-w-[1256px] mx-auto">
        {steps?.map((step, index) => (
          <div
            ...
            style={{ borderColor: borderColor?.value || '#E4DFDC' }}
          >
            <div
            ...
            >
              <div
                ...
                style={{ backgroundColor: borderColor?.value || '#E4DFDC' }}
              />
            </div>

            <div
              className={`${index !== steps.length - 1 ? "pt-0 pb-14 md:pb-20" : ""
            ...
            >
              <div className="gap-2 flex-1 grow flex flex-col items-start">
                <div
                  ...
                  style={{ backgroundColor: step.badgeColor?.value || '#F1ACC0' }}
                >
