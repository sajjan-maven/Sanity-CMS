        ...
        <section className="flex flex-col items-center justify-center px-6 py-14 md:py-[100px] w-full [background:linear-gradient(0deg,rgba(0,0,0,0.02)_0%,rgba(0,0,0,0.02)_100%),linear-gradient(0deg,rgba(250,249,248,1)_0%,rgba(250,249,248,1)_100%)]">
            ...
            <div className="relative flex flex-col lg:flex-row gap-[18px] w-full max-w-[1064px] mni-h-[490px]">
                ...
                {testimonials.length > 0 && (
                    <Link href="#" target="_blank" className="relative hover:border-blue-400 flex flex-col w-full lg:w-[265px] lg:min-h-[490px] items-start justify-start gap-6 p-8 pb-12 bg-white rounded-[32px] border border-solid border-[#545058]">
                            ...
                            <div className="flex flex-col items-start gap-4 w-full">
                                ...
                                <div className="flex items-center gap-4 w-full">
                                    <Image
                                        ...
                                        src={testimonials[0].avatar?.asset.url || '/schedule-demo/default-avatar.png'}
                                    />
                        ...
                        <div className="absolute right-4 bottom-4">
                            {testimonials[0].logo?.asset.url && (
                                <Image
                                    width={32}
                                    height={32}
                                    alt="Company Logo"
                                    src={testimonials[0].logo.asset.url}
                                />
                            )}
                        </div>
                    </Link>
                        ...
                        >
                                ...
                                <div className="flex flex-col items-start gap-4 w-full">
                                    ...
                                    <div className="flex items-center gap-4 w-full">
                                        <Image
                                            ...
                                            className="bg-gray-300 w-10 h-10 rounded-full overflow-hidden"
                                            src={testimonial.avatar?.asset.url || '/schedule-demo/default-avatar.png'}
                                        />
                            ...
                            <div className="absolute right-4 bottom-4">
                                {testimonial.logo?.asset.url && (
                                    <Image width={32} height={32} alt="Company Logo" src={testimonial.logo.asset.url} />
                                )}
                            </div>
                        </Link>
                    ))}
