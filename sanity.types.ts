...
// Query: *[_type == 'casestudy' && slug.current == $slug][0] {  _id,  _type,  _createdAt,  company,  'slug': slug.current,  content[],  relatedCaseStudies,  "relatedCasestudies": select(    relatedCaseStudies == "custom" => customRelatedPosts[]->{       _id,      _type,      _createdAt,      company,      'slug': slug.current,      logo {         asset->{ url },         altText       },      backgroundColor {        value      },      cardTitle,    },    relatedCaseStudies == "autofill" => *[_type == 'casestudy' && _id != ^._id][0...3]{       _id,      _type,      _createdAt,      company,      'slug': slug.current,      logo {         asset->{ url },         altText       },      backgroundColor {        value      },      cardTitle,    },  ),  "seo": {    "title": coalesce(seo.title, title, ""),    "description": coalesce(seo.description,  ""),    "noIndex": seo.noIndex == true,    "image": seo.image,  },}
...
// Query: *[_type == 'casestudy' && _id != $featuredId] | order(orderRank asc) {  _id,  _type,  company,  'slug': slug.current,  logo {     asset->{ url },     altText   },  backgroundColor {    value  },  cardTitle,  cardSummary,}
